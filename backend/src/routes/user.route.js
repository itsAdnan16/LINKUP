...
import { 
  ...
  acceptFriendRequest,
  getFriendRequests,
  getOutgoingFriendReqs  // Changed from getOutgoingFriendRequests
...
router.get("/outgoing-friend-requests", protectRoute, getOutgoingFriendReqs); // Updated function name
